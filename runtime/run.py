...
def run_training(train_data, params):
    ...
    mask_rcnn_model.fit(
        ...
        steps_per_epoch=params.steps_per_epoch or (params.train_size // params.global_train_batch_size),
        callbacks=list(create_callbacks(params)),
        verbose=0
    )


def run_evaluation(val_data, params):
    #setup(params)
...
def run_inference(test_data, params):
    #setup(params)
